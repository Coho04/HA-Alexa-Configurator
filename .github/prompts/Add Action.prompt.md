...
**File:** `custom_components/alexa_configurator/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: alexa_configurator
...
Create `custom_components/alexa_configurator/service_actions/[action_name].py`:

```python
"""[Action name] service action for Alexa Configurator."""
...
**File:** `custom_components/alexa_configurator/__init__.py`
...
**File:** `custom_components/alexa_configurator/const.py`
...
3. Find service action: `alexa_configurator.[action_name]`
...
- **Service actions directory:** `custom_components/alexa_configurator/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/alexa_configurator/services.yaml` (legacy filename)
- **Icons:** `custom_components/alexa_configurator/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/alexa_configurator/translations/*.json` under `services` key (legacy)
